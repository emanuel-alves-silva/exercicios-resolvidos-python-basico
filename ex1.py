"""
Enunciado:
O objetivo deste kata é descobrir quantas garrafas de uísque duty free você teria que comprar, de modo que a economia em relação ao preço normal nas ruas cobrisse efetivamente o custo das suas férias.
...
porcentagem = normPrice * dutyFree / 100

custo_economia = costHoliday / porcentagem

print(f'Você terá que comprar {int(custo_economia):.0f} garrafas para economizar {costHoliday}')